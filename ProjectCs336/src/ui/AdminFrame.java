...
public class AdminFrame extends JFrame {
    ...
    private void showAddUserDialog() {
        JOptionPane.showMessageDialog(this, "Use MySQL Workbench to add new users");
    }
    
    private void showEditUserDialog() {
        JOptionPane.showMessageDialog(this, "Use MySQL Workbench to edit users");
    }
    ...
    private void deleteUser() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(this, "Please use MySQL Workbench to delete users");
        }
    }
}